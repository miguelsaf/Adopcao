...
namespace Projeto_Final_de_Curso4.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_animal,id_cor,id_genero,id_tipo_de_animal,id_disponibilidade_do_animal,idade,raca,peso,foto")] tb_animal tb_animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_animal,id_cor,id_genero,id_tipo_de_animal,id_disponibilidade_do_animal,idade,raca,peso,foto")] tb_animal tb_animal)
        {
            if (ModelState.IsValid)
            {
